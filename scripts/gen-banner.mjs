...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .content { position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; gap:22px; padding:0 108px; }
  .logo { width:430px; object-fit:contain; }
  .title { font-family:'Gelasio', Georgia, serif; font-size:52px; font-weight:700; line-height:1.18; color:#0f172a; letter-spacing:-0.02em; }
  ...
  .tag { font-family:'Karla', sans-serif; font-size:24px; color:#475569; max-width:860px; line-height:1.6; font-weight:500; }
  .cta { display:inline-flex; align-items:center; gap:10px; background:#00a3ff; color:#04121f; font-family:'Karla',sans-serif; font-weight:700; font-size:21px; padding:15px 38px; border-radius:100px; box-shadow:0 12px 26px rgba(0,163,255,0.28); }
  .sign { font-family:'Caveat', cursive; font-size:26px; color:#00a3ff; }
</style>
</head><body>
<div class="canvas">
...
shot(bannerHtml, 1200, 630, path.join(OUT, 'bannerFacebook.png'));
